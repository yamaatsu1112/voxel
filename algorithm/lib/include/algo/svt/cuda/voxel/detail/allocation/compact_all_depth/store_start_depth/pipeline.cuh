...
#include <algo/svt/cuda/voxel/detail/allocation/compact_all_depth/store_start_depth/policy.cuh>
#include <algo/svt/cuda/voxel/detail/allocation/compact_all_depth/store_start_depth/traits.cuh>
...
namespace allocation::compact_all_depth::store_start_depth {
...
inline cudaError_t allocate_paths(DeviceGpuSvo svo, const LeafMask* leaf_masks,
    ...
    compact_all_depth::collect_materialize_counts_kernel<StoreStartDepth>
...
template <class InitMode, class ScheduleMode>
inline cudaError_t
allocation_impl<CompactAllDepthAllocation<InitMode, StoreStartDepth,
                                          ScheduleMode>>::
    allocate_paths(DeviceGpuSvo svo, const LeafMask* leaf_masks,
                   const std::uint32_t* leaf_count,
                   std::uint32_t leaf_mask_capacity, Workspace& workspace,
                   cudaStream_t stream) {
    return allocation::compact_all_depth::store_start_depth::allocate_paths<
