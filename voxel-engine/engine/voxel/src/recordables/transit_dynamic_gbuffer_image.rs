use crate::builders::configs::image_configs::{DynamicGBufferDepthImage, DynamicGBufferImage};
...
#[derive(Clone)]
pub struct TransitDynamicGBufferImage;

impl VkGraphicsRecordable for TransitDynamicGBufferImage {
