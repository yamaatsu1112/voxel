...
use crate::voxel::svo::grouped::descriptor_sets::{
...
fn bind_voxel_descriptor_sets(renderer: &mut Renderer<VulkanRenderer>) {
    ...
    bind_mixed_svo_component_buffers::<
        ...
        crate::voxel::svo::grouped::buffers::SVOCountersOriginalBuffer,
        crate::voxel::svo::grouped::buffers::IdSVOCountersOriginalBuffer,
        crate::voxel::svo::grouped::buffers::SVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::IdSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::SVOFreeLeafIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::IdSVOFreeLeafIndicesOriginalBuffer,
...
fn bind_dynamic_voxel_descriptor_sets(renderer: &mut Renderer<VulkanRenderer>) {
    ...
    bind_mixed_svo_component_buffers::<
        ...
        crate::voxel::svo::grouped::buffers::DynamicSVOCountersOriginalBuffer,
        crate::voxel::svo::grouped::buffers::DynamicIdSVOCountersOriginalBuffer,
        crate::voxel::svo::grouped::buffers::DynamicSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::DynamicIdSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::DynamicSVOFreeLeafIndicesOriginalBuffer,
        crate::voxel::svo::grouped::buffers::DynamicIdSVOFreeLeafIndicesOriginalBuffer,
    >(renderer, NUM_SVO_DATA);
