...
#[allow(dead_code)]
pub struct SvoIndividualVariant;
#[allow(dead_code)]
pub(crate) type Variant = SvoIndividualVariant;

impl SvoVariant for SvoIndividualVariant {
    type CpuSvo = SVOIndividual;
