...
use crate::builders::configs::pipeline_configs::voxel::{
...
pub(crate) const SLOT_PADDED: usize = 0;
pub(crate) const SLOT_ONE: usize = 1;
pub(crate) const SLOT_UNPADDED: usize = 2;
...
pub(crate) fn insert_memory_barrier_to_secondary_buffer(context: &VkSecondaryRecordContext) {
    let memory_barrier = vk::MemoryBarrier {
        s_type: vk::StructureType::MEMORY_BARRIER,
        p_next: ptr::null(),
        src_access_mask: vk::AccessFlags::SHADER_WRITE,
...
pub(crate) fn record_edit_stage_for_svo<P, D, I>(
    context: &VkSecondaryRecordContext,
    depth: u32,
    phase: u32,
    svo_index: usize,
...
pub(crate) fn record_one_thread_stage_for_svo<P, D>(
    context: &VkSecondaryRecordContext,
    depth: u32,
    phase: u32,
    svo_index: usize,
...
pub(crate) fn dispatch_indirect_for_svo<I>(
    context: &VkSecondaryRecordContext,
    svo_index: usize,
    slot: usize,
) where
