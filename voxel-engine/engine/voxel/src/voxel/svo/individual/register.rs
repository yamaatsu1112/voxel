...
use crate::voxel::svo::individual::pipelines::{
    CollisionComputePipeline, DynamicVoxelClearPipeline, RaycastComputePipeline,
    VoxelApplyDestroyPipeline, VoxelApplyPlacePipeline, VoxelCollectFreePipeline,
...
fn create_pipelines(renderer: &mut Renderer<VulkanRenderer>) {
    renderer.add_command(CreateComputePipelineCommand::<
        VoxelCollectMaterializePipeline,
    >::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelScanNodeOffsetsPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelScanLeafOffsetsPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<
        VoxelSnapshotAllocationPipeline,
    >::new());
    renderer.add_command(CreateComputePipelineCommand::<
    ...
    >::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelLinkMaterializedPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<
        VoxelCommitMaterializedPipeline,
    >::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelApplyPlacePipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelApplyDestroyPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelCollectFreePipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelScanFreeOffsetsPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<VoxelFreeBatchPipeline>::new());
    renderer.add_command(CreateComputePipelineCommand::<DynamicVoxelClearPipeline>::new());
...
fn bind_voxel_descriptor_sets(renderer: &mut Renderer<VulkanRenderer>) {
    ...
    bind_mixed_svo_component_buffers::<
        ...
        crate::voxel::svo::individual::buffers::SVOCountersOriginalBuffer,
        crate::voxel::svo::individual::buffers::IdSVOCountersOriginalBuffer,
        crate::voxel::svo::individual::buffers::SVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::IdSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::SVOFreeLeafIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::IdSVOFreeLeafIndicesOriginalBuffer,
...
fn bind_dynamic_voxel_descriptor_sets(renderer: &mut Renderer<VulkanRenderer>) {
    ...
    bind_mixed_svo_component_buffers::<
        ...
        crate::voxel::svo::individual::buffers::DynamicSVOCountersOriginalBuffer,
        crate::voxel::svo::individual::buffers::DynamicIdSVOCountersOriginalBuffer,
        crate::voxel::svo::individual::buffers::DynamicSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::DynamicIdSVOFreeNodeIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::DynamicSVOFreeLeafIndicesOriginalBuffer,
        crate::voxel::svo::individual::buffers::DynamicIdSVOFreeLeafIndicesOriginalBuffer,
    >(renderer, NUM_SVO_DATA);
