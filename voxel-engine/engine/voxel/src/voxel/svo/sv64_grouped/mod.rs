...
#[allow(dead_code)]
pub struct Sv64GroupedVariant;
#[allow(dead_code)]
pub(crate) type Variant = Sv64GroupedVariant;

impl SvoVariant for Sv64GroupedVariant {
    type CpuSvo = SV64Grouped;
